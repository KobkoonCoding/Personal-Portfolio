...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative flex items-center c-space section-spacing">
      ...
      <div
        ref={sectionRef}
        className={`flex flex-col items-center justify-center w-full max-w-sm sm:max-w-md p-5 mx-auto border border-white/10 rounded-2xl bg-primary scroll-reveal ${isVisible ? 'visible' : ''}`}
      >
